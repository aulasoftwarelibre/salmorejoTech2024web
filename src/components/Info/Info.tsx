            ...
            <div className="col-12 pt-5">
              ...
              <div className="row pt-5">
                <div className="container-fluid pt-5 col-md-6 justify-content-center" style={{margin: "auto"}}>
                  ...
                  <h4>Todo esto no hubiera sido posible sin la incondicional ayuda de todos nuestros patrocinadores y a todos los <a href="https://uco.es/aulasoftwarelibre/aula" style={{color: 'white'}}>compañeros</a> del Aula de Software Libre</h4>
                </div>
