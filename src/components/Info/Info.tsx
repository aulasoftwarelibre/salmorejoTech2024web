...
const lazyLoadedImages: { [key: string]: () => Promise<string> } = {
  imagen0: () => import("../../sprites/imagenesInicio/0-min.jpg").then(module => module.default),
  imagen1: () => import("../../sprites/imagenesInicio/1-min.jpg").then(module => module.default),
  imagen2: () => import("../../sprites/imagenesInicio/2-min.jpg").then(module => module.default),
  imagen3: () => import("../../sprites/imagenesInicio/3-min.jpg").then(module => module.default),
  imagen4: () => import("../../sprites/imagenesInicio/4-min.jpg").then(module => module.default),
  imagen5: () => import("../../sprites/imagenesInicio/5-min.jpg").then(module => module.default),
  imagen6: () => import("../../sprites/imagenesInicio/6-min.jpg").then(module => module.default),
  imagen7: () => import("../../sprites/imagenesInicio/7-min.jpg").then(module => module.default),
  imagen8: () => import("../../sprites/imagenesInicio/8-min.jpg").then(module => module.default),
...
export default function Info() {
  ...
  // Load lazy loaded images on component mount
  useEffect(() => {
                ...
                <div className={`carousel-inner ${styles.middle}`}>
                  {Object.keys(images).map((imageName, index) => (
                    <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
                      <img src={images[imageName]} className="d-block w-100" alt="imagen" />
                    </div>
                  ))}
                </div>
